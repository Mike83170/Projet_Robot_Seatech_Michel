...
//void PWMSetSpeed(unsigned char numMoteur, float vitesseEnPourcents) {
...
//    }
//    if (numMoteur == MOTEUR_DROIT)
//    {
//        //void PWMSetSpeed2(float vitesseEnPourcents) {
...
void PWMSetSpeedConsigne(float vitesseEnPourcents, unsigned char numMoteur) 
{
     ...
     else if (numMoteur==MOTEUR_GAUCHE)
